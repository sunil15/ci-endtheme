...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="<?php echo base_url(); ?>assets/themes/admin/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	
	<!-- Font Awesome -->
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/font-awesome.min.css" rel="stylesheet">
	
	<!-- Pace -->
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/pace.css" rel="stylesheet">
	
	<!-- Color box -->
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/colorbox/colorbox.css" rel="stylesheet">
	
	<!-- Morris -->
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/morris.css" rel="stylesheet"/>	
	
	<!-- Endless -->
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/endless.min.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/themes/admin/css/endless-skin.css" rel="stylesheet">
    </head>
	...
	<!-- Jquery -->
	<script src="<?php echo base_url(); ?>assets/themes/admin/js/jquery-1.10.2.min.js"></script>

	<!-- Bootstrap -->
        <script src="<?php echo base_url(); ?>assets/themes/admin/bootstrap/js/bootstrap.js"></script>
   
	<!-- Flot -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.flot.min.js'></script>
   
	<!-- Morris -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/rapheal.min.js'></script>	
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/morris.min.js'></script>	
	
	<!-- Colorbox -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.colorbox.min.js'></script>	

	<!-- Sparkline -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.sparkline.min.js'></script>
	
	<!-- Pace -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/uncompressed/pace.js'></script>
	
	<!-- Popup Overlay -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.popupoverlay.min.js'></script>
	
	<!-- Slimscroll -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.slimscroll.min.js'></script>
	
	<!-- Modernizr -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/modernizr.min.js'></script>
	
	<!-- Cookie -->
	<script src='<?php echo base_url(); ?>assets/themes/admin/js/jquery.cookie.min.js'></script>
	
	<!-- Endless -->
	<script src="<?php echo base_url(); ?>assets/themes/admin/js/endless/endless_dashboard.js"></script>
	<script src="<?php echo base_url(); ?>assets/themes/admin/js/endless/endless.js"></script>
    </body>
